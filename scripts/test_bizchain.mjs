...
ok('②b ⬇️ 台積電要看得到下游(先進封裝)', /下游/.test(R.tsmc) && /先進封裝/.test(R.tsmc));
ok('②c ⭐ 最上游那一檔(矽晶圓)⛔ 不可有上游,但要有下游',
   !/⬆️ 上游/.test(R.wafer) && /⬇️ 下游/.test(R.wafer) && /晶圓代工/.test(R.wafer), R.wafer.slice(0, 200));
