...
const R = await page.evaluate(async () => {
    ...
    // ④⑨ stub screener:2330 有值、4585 缺 chg20(null)→ 顯 '—'
    app._scrData = { data_date: '2026-08-26', cols: ['chg20', 'f10', 'yoy'], rows: {}, ind: {} };
    app._scrC = { chg20: 0, f10: 1, yoy: 2 };
    for (const s of C.stocks) app._scrData.rows[s[0]] = [5.5, 1200, 30];
    app._scrData.rows['4585'] = [null, null, null];
    ...
    // ⑤ 層級篩選
    app._aicSetLv(5);
    const map2 = body.innerHTML.slice(body.innerHTML.indexOf('個股地圖'));
