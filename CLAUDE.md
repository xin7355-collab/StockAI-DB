...
⏭️ **其餘頁面還沒改**(使用者要先看過報告頁這一版)—— ⛔ 但**新東西一律照無框寫**,別再照上面那張
「卡片三段式樣板」加框。全站還有 `bg-[#161b22]` **349** 處 / 四邊框 **374** 處 / **213 種**組合,
其中真的等於樣板的只有 **15** 處;最該先推的三個(已量,左右吃最多):
總覽摺疊→深度診斷 **77px** ・X 光機 `#corpMoreWrap` **74px** ・總覽 A 狀態卡 **59px**。
