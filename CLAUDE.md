...
| `volstall_probe.py` | 「爆量漲不動/跌不動」有沒有邊際(V71.9.8) | ⛔ 日線版已驗**不成立**;要驗真正的「連次量」需分 K 歷史 |
...
⛔ **不上任何日線版連次量訊號**。要做真正的連次量,得先有分 K 歷史
(Shioaji `api.kbars()` 免費約 81 個交易日,ORB 探針已驗證可行)—— ⚠️ 但照 ORB 那次的鐵則,
**必須扣掉當沖來回成本 ~0.25% 再看淨期望**,毛利正不代表能賺。
