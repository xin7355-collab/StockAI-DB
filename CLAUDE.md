...
| 「SaaS-card kit:一堆一模一樣的圓角卡、同一個 border-radius」 | `bg-[#161b22] border-[#30363d] rounded-lg p-3` 全站重複 | ⛔ **不改**(一致性 > 獨特性,這是工具不是官網) |
...
⛔ **裝了它也不會讓 2330 那頁的 12,419 字變少** —— 資訊密度要靠 `_TIDY` 與砍卡流程,不是設計外掛。
